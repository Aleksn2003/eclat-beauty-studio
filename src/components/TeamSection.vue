...
const team = [
  {
    ...
    focus: ['Стрижки', 'Укладки', 'Окрашивание'], image: 'hair.webp', position: '50% 30%', service: 'hair', credentials: [],
  },
  {
    ...
    focus: ['Уход', 'Увлажнение', 'Комфорт кожи'], image: 'portrait.webp', position: '50% 62%', service: 'skin', credentials: [],
  },
  {
    ...
    focus: ['Форма', 'Цвет', 'Ресницы'], image: 'makeup.webp', position: '50% 35%', service: 'brows', credentials: [],
  },
]
</script>
