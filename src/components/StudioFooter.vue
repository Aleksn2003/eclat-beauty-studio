...
Ответы на вопросы о первом визите и возможностях этой демонстрационной страницы.
    ...
    <div class="section-rule border-b-0">
      <div class="container-shell py-12">
        ...
        <p class="mt-3 max-w-3xl text-[10px] font-medium text-[#6b726c]" lang="en">Authorship and Use</p>
        <p class="mt-1 max-w-3xl text-[10px] leading-relaxed text-[#8a908b]" lang="en">Template author: <a href="https://github.com/Aleksn2003" target="_blank" rel="noopener noreferrer" class="underline decoration-[#e7d6bf] underline-offset-4 hover:text-[#946431]">Aleksn2003</a>. All rights to the template's original code, structure, and design remain with the author. Reuse requires prior permission. Viewing and forking on GitHub are governed by the <a href="https://docs.github.com/en/site-policy/github-terms/github-terms-of-service" target="_blank" rel="noopener noreferrer" class="underline decoration-[#e7d6bf] underline-offset-4 hover:text-[#946431]">GitHub Terms of Service</a> and do not grant an open license.</p>
